...
var insertImage = function insertImage(editorState, matchArr, entityType) {
  ...
  var nextContent = currentContent.createEntity(entityType, "IMMUTABLE", {
    alt: alt,
    src: src,
    title: title
  });
  ...
  newEditorState = _draftJs.AtomicBlockUtils.insertAtomicBlock(newEditorState, newEditorState.getCurrentContent().getLastCreatedEntityKey(), " ");
