...
defaultConfig.customComponents[_constants.CODE_BLOCK_TYPE] = true;
defaultConfig.customComponents[_draftJsCheckableListItem.CHECKABLE_LIST_ITEM] = true;
...
var createMarkdownPlugin = function createMarkdownPlugin() {
  ...
  var config = _extends({}, defaultConfig, _config, {
    ...
    customComponents: _extends({}, defaultConfig.customComponents, _config.customComponents)
  });

  return {
    store: store,
    blockRenderMap: _draftJsCheckableListItem.blockRenderMap,
    ...
    handleBeforeInput: function handleBeforeInput(character, editorState, _ref7) {
      ...
      if (character === " " && (0, _utils.getCurrentLine)(editorState).slice(-1) === " ") return "handled";
